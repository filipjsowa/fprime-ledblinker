...
To run the ground system without starting the LedBlinkerDeployment app:
```
...
```
cd LedBlinkerDeployment/build-artifacts/<platform>/bin/
./LedBlinkerDeployment -a 127.0.0.1 -p 50000
```
